...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> userAlreadyExistException (Exception e, WebRequest request){
        ExceptionResponse exceptionResponse = new ExceptionResponse(LocalDate.now(), e.getMessage(), "USER");
        return new ResponseEntity<>(exceptionResponse, HttpStatus.BAD_REQUEST);
    }
    ...
    public final ResponseEntity<ExceptionResponse> signatureException (Exception e, WebRequest request){
